...
import CowImage from 'assets/cow-swap/cow_v2.png'
      ...
      <CardsWrapper>
        ...
        <Card>
          <BalanceDisplay titleSize={26}>
            ...
            <span>
              <i>Available ARC balance</i>
              <b title={`${cowBalanceMax} COW`}>{cowBalance} ARC</b>
            </span>
          </BalanceDisplay>
        </Card>
        ...
        <BannerCard>
          <span>
            <b>ARC DAO Governance</b>
            <small>Use your ARC balance to vote on important proposals or participate in forum discussions.</small>
            <span>
              {' '}
              {/* <ExtLink href={'https://snapshot.org/#/cow.eth'}>View proposals ↗</ExtLink>
              <ExtLink href={'https://forum.cow.fi/'}>ARC Forum ↗</ExtLink> */}
            </span>
          </span>
